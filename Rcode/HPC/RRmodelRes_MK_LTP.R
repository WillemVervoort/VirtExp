...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr.Rdata",sep="_"))
#save(Station_resid,file=paste(Sys.Date(),"Store_SH_st.Rdata",sep="_"))
save(Station_resid,file=paste(Today,"Store_SH_gr.Rdata",sep="_"))
