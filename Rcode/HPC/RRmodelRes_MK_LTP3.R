...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr4.Rdata",sep="_"))
save(Station_resid,file=paste(Sys.Date(),"Store_SH_st4.Rdata",sep="_"))
#save(Station_resid,file=paste(Today,"Store_SH_gr4.Rdata",sep="_"))
