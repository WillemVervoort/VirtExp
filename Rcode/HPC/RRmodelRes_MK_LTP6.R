...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr7.Rdata",sep="_"))
#save(Station_resid,file=paste(Sys.Date(),"Store_SH_st7.Rdata",sep="_"))
save(Station_resid,file=paste(Today,"Store_SH_gr7.Rdata",sep="_"))
