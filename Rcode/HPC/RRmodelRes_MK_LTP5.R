...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr6.Rdata",sep="_"))
#save(Station_resid,file=paste(Sys.Date(),"Store_SH_st6.Rdata",sep="_"))
save(Station_resid,file=paste(Today,"Store_SH_gr6.Rdata",sep="_"))
