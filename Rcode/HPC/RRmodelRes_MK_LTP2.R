...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr3.Rdata",sep="_"))
#save(Station_resid,file=paste(Sys.Date(),"Store_SH_st3.Rdata",sep="_"))
save(Station_resid,file=paste(Today,"Store_SH_gr3.Rdata",sep="_"))
