...
#save(Station_resid,file=paste(Sys.Date(),"Store_GR4J_gr2.Rdata",sep="_"))
#save(Station_resid,file=paste(Sys.Date(),"Store_SH_st2.Rdata",sep="_"))
save(Station_resid,file=paste(Today,"Store_SH_gr2.Rdata",sep="_"))
