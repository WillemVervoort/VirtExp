...
load("20150925_gamm.list_noLag.Rdata")
...
load("C:/Users/rver4657/ownCloud/Virtual Experiments/For Willem_05_06_2015/Streamflow_data/20160219_FigureResidGAM_MDPaper.Rdata")
...
load("20150918_gamm.list_TrendOnly.Rdata")
...
load("20150918_Store3_RainTrendOnlyAnalysis.RData")
