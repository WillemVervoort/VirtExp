...
load("20160727_gamm.list_noLag.Rdata")
...
save(hp, file=paste(Today,"_FigureResidGAM_MDPaper.Rdata",sep=""))
load("20160727_FigureResidGAM_MDPaper.Rdata")

# # production quality
tiff(paste("C:/Users/rver4657/ownCloud/Virtual Experiments/",Today,"_FigureResidGAM_MDPaper.tif",sep=""),res=600,compression="lzw",
     width=10*480,height=10*480)
# quicktiff
# tiff(paste(Today,"_DraftFigureResidGAM_MDPaper.tif",sep=""),
...
load("20160727_gamm.list_noLagTrend.Rdata")
...
# draft quality
tiff(paste(Today,"_TrendsMaxTRainGamm.tif",sep=""),
...
# draft quality
tiff(paste(Today,"_TrendsRainGamm.tif",sep=""),
     width=2*480,height=2*480)
print(p)
...
load("20160727_gamm.list_RainOnly.Rdata")
...
Store1
# Save
save(Store1,file=paste(Today,"Store1_Rain&TrendOnlyAnalysis.RData",sep="_"))
...
load("20160727_gamm.list_TrendOnly.Rdata")
...
load("20150918_Store2_TrendOnlyAnalysis.RData")
# ----------- end 4. ------------------
...
load("20160727_gamm.list_RainTrendOnly.Rdata")
...
save(Store3,file=paste(Today,"Store3_RainTrendOnlyAnalysis.RData",sep="_"))

load("20160727_Store3_RainTrendOnlyAnalysis.RData")
