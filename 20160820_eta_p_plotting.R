...
OutputChiewSH <- read.csv("20160805_SimHydHPC_ChiewAnalysis.csv")
OutputChiewGR4J <- read.csv("20160805_GR4JHPC_ChiewAnalysis.csv")
non_par_eta <- read.csv("20160804_non_par_eta.csv")
...
save(p,file=paste(Today,"_RainfallElasticityPlot.RData",sep=""))
load("20160820_RainfallElasticityPlot.RData")
...
# publication quality
tiff(paste("manuscript/",Today,"Figure3_RainfallElasticityPlot.tif",sep=""),
     width=16*480,height=12*480,
     res=600, compression="lzw")
print(p)
dev.off()

OutputTrendsSH <- read.csv("20160805_SimHydHPC_trendsAnalysis.csv")
OutputTrendsGR4J <- read.csv("20160805_GR4JHPC_trendsAnalysis.csv")
...
tiff(paste("C:/Users/rver4657/ownCloud/Virtual Experiments/manuscript/",
           Today,"Figure4_ModelCalStats.tif",sep=""),width=16*480,height=12*480,
     res=600, compression="lzw")
print(p)
dev.off()
...
p <- p + stat_summary(fun.y=mean, geom="point", shape=16, size=5,aes(col=sig),lwd=2)
...
# Normal quality
tiff(paste("C:/Users/rver4657/ownCloud/Virtual Experiments/manuscript drafts/",
           Today,"Figure9_ModelResidualTrendPlot.tif",sep=""),width=720,height=720)
print(p)
dev.off()
...
# publication quality
tiff(paste("manuscript/",
           Today,"Figure9_ModelResidualTrendPlot.tif",sep=""),width=16*480,height=12*480,
     res=600, compression="lzw")
print(p)
dev.off()
