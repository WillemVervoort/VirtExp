...
OutputChiewSH <- read.csv("20151110_SimHydHPC_ChiewAnalysis.csv")
OutputChiewGR4J <- read.csv("20151110_GR4JHPC_ChiewAnalysis.csv")
non_par_eta <- read.csv("C:/Users/rver4657/ownCloud/Virtual Experiments/20151110_non_par_eta.csv")
...
load("C:/Users/rver4657/ownCloud/Virtual Experiments/HPC/MD_Projectdata/20160218_RainfallElasticityPlot.RData")
...
OutputTrendsSH <- read.csv("20151110_SimHydHPC_trendsAnalysis.csv")
OutputTrendsGR4J <- read.csv("20151110_GR4JHPC_trendsAnalysis.csv")
