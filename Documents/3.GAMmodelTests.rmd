...
#   i <- 1
  ...
  out <- list(model = gam_TrendOnly,
              results = data.frame(Station=Stations[i,1],                                 t(summary(gam_TrendOnly)$tTable[2,c(1,4)]),
...
pander(output, caption="Mixed model results for the analysis of flow data taking into account Rainfall and Evapotranspiratiion")
rm(Store_FwRE2)
```
